...
class Spending_Tracker_Transactions extends AT_Comments_Utils {
	...
	public function display_transaction_form() {
		AT_Display_Utils::get_template_part( SPENDTRACK_DIR, SPENDTRACK_PATH . 'templates', 'transactions', 'form' );
	}
	...
	public function display_next_transaction( $args ) {
		...
		AT_Display_Utils::get_template_part( SPENDTRACK_DIR, SPENDTRACK_PATH . 'templates', 'transactions', 'next', 'list', false );
	}
